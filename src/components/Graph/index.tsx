    ...
    if (active && payload && payload.length) {
        return (
            <div className={styles.customTooltip}>
                <p className={styles.label}>Year: {label}</p>
            ...
            <ResponsiveContainer width="100%" height={400}>
                <LineChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 10 }}>
                    ...
                    <Line
                        ...
                        name="Solar"
                        dot={false}
                        activeDot={{ r: 6, strokeWidth: 0, fill: "#FF7E45" }}
                    />
                    <Line
                        type="monotone"
                        dataKey="wind"
                        ...
                        name="Wind"
                        dot={false}
                        activeDot={{ r: 6, strokeWidth: 0, fill: "#4C9AFF" }}
                    />
                    <Line
                        type="monotone"
                        dataKey="coal"
                        ...
                        name="Coal"
                        dot={false}
                        activeDot={{ r: 6, strokeWidth: 0, fill: "#6B778C" }}
                    />
                    <Line
                        type="monotone"
                        dataKey="hydropower"
                        ...
                        name="Hydropower"
                        dot={false}
                        activeDot={{ r: 6, strokeWidth: 0, fill: "#36B37E" }}
                    />
                </LineChart>
            </ResponsiveContainer>
            <p className={styles.chartDescription}>
                📉 Renewable energy costs continue to decrease while traditional sources remain higher
            </p>
        </div>
    );
}
